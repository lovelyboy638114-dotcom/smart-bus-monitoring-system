...
const StudentDashboard = () => {
  ...
  const idCardData = student ? {
    ...
    bus_id: student.busId || student.assignedBus || 'TN38AB1234',
    blood_group: student.bloodGroup || 'B+',
    parent_name: student.parentName || 'Guardian',
    parent_phone: student.parentPhone || 'N/A',
    route_id: student.routeId || 'R-01',
    address: student.address || 'Campus Region',
