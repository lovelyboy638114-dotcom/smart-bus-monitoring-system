...
import com.safebus.assignment.repository.StopAssignmentRepository;
...
public class GeocodingService {
    ...
    private final StopAssignmentRepository stopAssignmentRepository;
    private final Map<String, double[]> geocodeCache = new ConcurrentHashMap<>();

    public GeocodingService(RestTemplate restTemplate, StopAssignmentRepository stopAssignmentRepository) {
        this.restTemplate = restTemplate;
        this.stopAssignmentRepository = stopAssignmentRepository;
    }
    ...
    private double[] offlineFallbackMatch(String address) {
        ...
        List<Stop> stops = stopAssignmentRepository.findAll();
        Stop bestStop = null;
        int maxMatches = 0;
